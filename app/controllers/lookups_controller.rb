class LookupsController < ApplicationController
  ...
  def review
    ...
    @body = "Dear [Your reps name]

In light of the mounting evidence of marijuana’s medical efficacy, I urge you to support giving seriously ill patients in our state legal access to marijuana with a doctor’s recommendation.
